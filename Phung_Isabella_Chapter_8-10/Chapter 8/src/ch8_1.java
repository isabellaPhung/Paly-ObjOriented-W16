...
class TeamMaker{
	...
	static TeamMaker[] baseballTeam= new TeamMaker[25]; //array of player objects
	static int numOfPlayers=1; //tracks num of plaers
	...
	public static void totalSalary(){ //determines salary average of team
		...
		for(int i=0;i<numOfPlayers-1;i++){ //totals salaries
			TeamMaker player= baseballTeam[i];
	...
	public static TeamMaker[] getBaseballTeam() {
		return baseballTeam;
	}
